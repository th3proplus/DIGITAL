...
const svgIcons: { [key: string]: React.ReactNode } = {
    ...
    tiktok: <path d="M12.53.02C13.84.01 15.14 0 16.44 0c.08 1.53.63 3.09 1.75 4.17 1.12 1.12 2.7 1.62 4.24 1.8V10c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.05-4.84-.94-6.37-2.96-2.2-2.95-2.2-6.87 0-9.85 1.59-2.12 4.19-3.26 6.78-2.91 1.18.16 2.35.63 3.39 1.31V6.11c-.99-.3-2.02-.45-3.03-.51-1.31-.08-2.62 0-3.92.01L7.54 2l.02 4.03c.61-.02 1.22-.02 1.84-.02 1.3 0 2.6-.01 3.91-.02.01-.52.02-1.04.02-1.56Z" />,
